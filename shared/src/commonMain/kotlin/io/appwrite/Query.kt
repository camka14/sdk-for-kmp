...
class Query(
    ...
    companion object {
         ...
         * @returns The query string.
         */
        fun orderRandom() = Query("orderRandom").toString()
         ...
         * @returns The query string.
         */
        fun notContains(attribute: String, value: Any) =
            Query("notContains", attribute, parseValue(value)).toString()
         ...
         * @returns The query string.
         */
        fun notSearch(attribute: String, value: String) =
            Query("notSearch", attribute, listOf(value)).toString()
         ...
         * @returns The query string.
         */
        fun notBetween(attribute: String, start: Any, end: Any) =
            Query("notBetween", attribute, listOf(start, end)).toString()
         ...
         * @returns The query string.
         */
        fun notStartsWith(attribute: String, value: String) =
            Query("notStartsWith", attribute, listOf(value)).toString()
         ...
         * @returns The query string.
         */
        fun notEndsWith(attribute: String, value: String) =
            Query("notEndsWith", attribute, listOf(value)).toString()
        ...
        fun or(queries: List<String>) =
            Query("or", null, queries.map { it.fromJson<Query>() }).toString()
        ...
        fun and(queries: List<String>) =
            Query("and", null, queries.map { it.fromJson<Query>() }).toString()
        ...
        fun distanceEqual(
            ...
            distance: Number,
            meters: Boolean = true
        ) = Query("distanceEqual", attribute, listOf(listOf(values, distance, meters))).toString()
        ...
        fun distanceNotEqual(
            ...
            "distanceNotEqual",
            attribute,
            listOf(listOf(values, distance, meters))
        ).toString()
         ...
         * @returns The query string.
         */
        fun intersects(attribute: String, values: List<Any>) =
            Query("intersects", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun notIntersects(attribute: String, values: List<Any>) =
            Query("notIntersects", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun crosses(attribute: String, values: List<Any>) =
            Query("crosses", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun notCrosses(attribute: String, values: List<Any>) =
            Query("notCrosses", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun overlaps(attribute: String, values: List<Any>) =
            Query("overlaps", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun notOverlaps(attribute: String, values: List<Any>) =
            Query("notOverlaps", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun touches(attribute: String, values: List<Any>) =
            Query("touches", attribute, listOf(values)).toString()
         ...
         * @returns The query string.
         */
        fun notTouches(attribute: String, values: List<Any>) =
            Query("notTouches", attribute, listOf(values)).toString()
